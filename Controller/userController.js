...
module.exports.Signup = async (req, res) => {
    try {
        ...
        const link = `https://flourishing-froyo-66faf3.netlify.app/accountactivation/${randomString}`;
...
module.exports.PasswordResetLink = async (req, res) => {
    try {
        ...
        const link = `https://flourishing-froyo-66faf3.netlify.app/PasswordReset/${randomString}`;
